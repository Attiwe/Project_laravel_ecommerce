<div>
  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Shopping</span></h1>
  ...
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
     ...
     <div class="bg-white rounded-lg shadow-md dark:bg-gray-800 "wire:key="{{$brand->id}}" >
        <a wire:navigate href="/products?select_brand[0]={{$brand->id}}" class="">
          <img src="{{$brand->image}}" alt="" class="object-cover w-full h-64 rounded-t-lg">
        </a>
  ...
  <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
       ...
       <a wire:navigate class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
        href="/products?selected_catagres[0]={{$Categorys->id}}" wire:key="{{$Categorys->id}}">
        <div class="p-4 md:p-5">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{$Categorys->image}}" alt="Image Description">
              <div class="ms-3">
